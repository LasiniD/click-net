		...
		<div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
			...
			<div className="col-span-1 lg:col-span-3">
				<div className="bg-gray-100 rounded-lg shadow-md p-6 mb-6">
					<h1 className="text-2xl font-bold mb-6 text-gray-800">My Network</h1>

					{/* Connection Requests */}
					{connectionRequests?.data?.length > 0 ? (
						<div className="mb-8">
							<h2 className="text-xl font-semibold mb-2 text-gray-800">Connection Requests</h2>
						...
						<div className="bg-white rounded-lg shadow-md p-6 text-center mb-6">
							...
							<h3 className="text-xl font-semibold text-gray-800 mb-2">No Connection Requests</h3>
